...
INSERT INTO `faq` VALUES (59, 'item', 'How do I make my bittorrent client use a proxy?', 'Just configure Windows XP as above. When you configure a proxy for Internet Explorer you
...
CREATE TABLE `users` (
  ...
  `donated` decimal(5,2) unsigned NOT NULL default '0',
...
INSERT INTO `users` VALUES (1, 'Admin', '21232f297a57a5a743894a0e4a801fc3', 0xec5bd32b5c5a962f41bb1848df12ce658d54023b, 'email@address.com', 'confirmed', '2005-07-06 12:03:29', '2006-09-27 21:35:45', '2006-09-29 10:57:44', '', 'strong', 1, '1', NULL, 'no', '86.134.184.202', 5, '', 1070000000, 100000000, '', '', 'System Admin', 0, 12, '', 'yes', '', 'Female', 'mine', 10, 'no', 'Site Admin', 1159527454, 'no', 2, '', 5, '0000-00-00 00:00:00', 0, 'no', 'c065197712e6db9ba96055ace93a2867');