...
$res = mysql_query("SELECT id, username, class, donated, warned FROM users WHERE UNIX_TIMESTAMP(" . get_dt_num() . ") - UNIX_TIMESTAMP(last_access) < 900 ORDER BY username");
...
begin_frame();
echo "<center><b><font color=#0000AA>Member</font> | <font color=#C0C0C0>Uploader</font> | <font color=#FEDE01>VIP</font> | <font color=#000000>Moderator</font> | <font color=#A83838>Super Moderator</font> | <font color=#FF0000>Administrator</font> <br><img src=\"images/warned.gif\"><font color=#008000> Warning</font> | <img src=\"images/star.gif\"><font color=#008000> Donator</font> <br><br></b></center>";
end_frame();

begin_frame("" . ONLINE_USERS . "", center);
