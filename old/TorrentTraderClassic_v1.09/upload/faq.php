            ...
            if (array_key_exists("items", $faq_categ[$id])) {
                foreach ($faq_categ[$id]['items'] as $id2 => $temp) {
                    if ($faq_categ[$id]['items'][$id2]['flag'] == "1") {
                        print("
        <li><a href=\"#".$id2."\" class=\"altlink\">".stripslashes($faq_categ[$id]['items'][$id2]['question'])."</a></li>\n");
                    } elseif ($faq_categ[$id]['items'][$id2]['flag'] == "2") {
                        print("
        <li><a href=\"#".$id2."\" class=\"altlink\">".stripslashes($faq_categ[$id]['items'][$id2]['question'])."</a> <img src=\"/images/updated.png\" alt=\"Updated\" width=\"46\" height=\"13\" align=\"absbottom\"></li>\n");
                    } elseif ($faq_categ[$id]['items'][$id2]['flag'] == "3") {
                        print("
        <li><a href=\"#".$id2."\" class=\"altlink\">".stripslashes($faq_categ[$id]['items'][$id2]['question'])."</a> <img src=\"/images/new.png\" alt=\"New\" width=\"25\" height=\"12\" align=\"absbottom\"></li>\n");
                    }
                }
            }
            echo '
