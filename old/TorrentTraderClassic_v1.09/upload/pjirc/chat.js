...
ltxt[ 0] = ["is away!","keluar!"];
ltxt[ 1] = ["Reason:","Sebab:"];
ltxt[ 2] = ["is back","telah kembaliii"];
ltxt[ 3] = ["from:","dari:"];
ltxt[ 4] = ["Guest","Tetamu"];
ltxt[ 5] = ["away time","masa keluar"];
ltxt[ 6] = ["you are already away!","Anda telah pun keluar!"];
ltxt[ 7] = ["you are not away!","Anda belum keluar!"];
