...
{
    print("\t\t</td>\n"
            ."\t\t<td class=block_right width=15><span class=space></span></td>\n"
            ."\t</tr>\n"
            ."\t<tr>\n"
            ."\t\t<td class=block_bottoml width=15 height=23><span class=space></span></td>\n"
            ."\t\t<td class=block_bottom></td>\n"
            ."\t\t<td class=block_bottomr width=15 height=23><span class=space></span></td>\n"
            ."\t</tr>\n"
            ."</table>");
}
