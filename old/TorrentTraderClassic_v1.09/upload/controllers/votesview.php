...
print("<p>" . $txt['VOTE_FOR_THIS'] . "<a href=requests.php?sa=addvote&id=$requestid><b>" . $txt['REQUEST'] . "</b></a></p>");
...
if (! $res) {
    ...
    print("
        <center><table cellspacing=0 cellpadding=3 class=table_table>
    ...
    foreach ($res as $arr) {
        ...
        echo '
            <tr><td class=table_col1>
            <a href=account-details.php?id='.$arr['userid'].'>
                <b>'.$arr['username'].'</b>
            </a></td>
