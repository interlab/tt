...
<?php
    ...
    if (phpversion() < 7){
        echo '<b><font color="red">No</font> 7 or above required</b>';
        echo " - Your PHP version is " . _PHP_VERSION;
    }
    if (phpversion() > 7) {
        echo "<font color=green>PHP 7 supported</font>";
        echo " - Your PHP version is " . _PHP_VERSION;
    }
...
$php_recommended_settings = array(array ('Safe Mode','safe_mode','OFF'),
							...
							array ('Register Globals - If OFF, TorrentTrader will emulate them as ON','register_globals','OFF'),
