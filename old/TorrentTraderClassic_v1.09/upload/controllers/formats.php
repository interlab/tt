...
"archive" this is just a way of making the files more compact and easier to download.
To open any of those archives listed above you can use <a href="http://www.rarsoft.com/download.htm">
WinRAR</a> or <a href="http://www.powerarchiver.com/download/">PowerArchiver</a>.<br>
<br>
...
<br>
<br>
<font color="red"><b>Edit:</b></font> With WinRAR, Double click on the first file (i.e. *.rar, *.r01 or *.001) and then "Extract to",<br>
(choose a destination)... Then check the following box: "<b>Extract and update files</b>", otherwise<br>
WinRAR will extract and replace the file leaving you with a ~15mb big image file in the end...  :-\<br>
<br>
<br>
<b>.cbr .cbz</b><br>
<br>
...
<?php begin_frame("Multimedia Files"); ?>
...
<a href="http://www.bsplayer.org/">BSPlayer</a>, or <a href="http://www.microsoft.com/windows/
...
<a href="http://www.apple.com/quicktime/download/">get it here</a>.<br>
<br>
<br>
<b>.ra .rm .ram</b><br>
<br>
...
<a href="http://service.real.com/downloads.html">here</a>.<br>
<br>
<br>
<b>vcd/svcd</b><br>
<br>
...
<?php begin_frame("CD Image Files");?>
<b>.bin and .cue</b><br>
<br>
