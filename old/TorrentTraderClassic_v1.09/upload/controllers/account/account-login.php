...
<form method="post" action="account-login.php">
    ...
    <table border="0" cellpadding=5>
        <tr><td><B><?= $txt['USERNAME'] ?>:</B></td>
        <td align=left><input type="text" size=40 name="username" /></td></tr>
        <tr><td><B><?= $txt['PASSWORD'] ?>:</B></td>
        <td align=left><input type="password" size=40 name="password" /></td></tr>
        <tr><td colspan="2" align="center"><input type="submit" value="<?= $txt['LOGIN'] ?>" class="btn">
        <BR><BR><i><?= $txt['COOKIES'] ?></i></td></tr>
    </table>
    </div>
<?php
