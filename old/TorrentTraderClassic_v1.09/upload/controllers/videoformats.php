...
?>
<center><h3><font color=#FF0000>Downloaded a movie and don't know what CAM/TS/TC/SCR means?</font></center></h3>
<?php begin_frame('CAM') ?>
...
<?php begin_frame("DVD-SCREENER (DVDscr)") ?>
...
<?php begin_frame("VHSRip") ?>

Transferred off a retail VHS, mainly skating/sports videos and XXX releases.
<?php end_frame(); ?>

<?php begin_frame("TVRip") ?>
...
of it. Generally avoid.
<?php end_frame(); ?>

<?php begin_frame("Watermarks") ?>
...
of the corners. Most famous are the "Z" "A" and "Globe" watermarks.
<?php end_frame(); ?>

<?php begin_frame("Asian Silvers / PDVD") ?>
...
<?php begin_frame("Scene Tags...") ?>

<?php end_frame(); ?>

<?php begin_frame("PROPER") ?>
...
<?php begin_frame("LIMITED") ?>

A limited movie means it has had a limited theater run, generally opening in less than
250 theaters, generally smaller films (such as art house films) are released as limited.
<?php end_frame(); ?>

<?php begin_frame("INTERNAL") ?>
...
<?php begin_frame("ASPECT RATIO TAGS") ?>

These are *WS* for widescreen (letterbox) and *FS* for Fullscreen.
<?php end_frame(); ?>

<?php begin_frame("REPACK") ?>

If a group releases a bad rip, they will release a Repack which will fix the problems.
<?php end_frame(); ?>

<?php begin_frame("NUKED") ?>
